...
describe("StubInMemoryRepository", () => {
  ...
  test('should throw error on update when entity not found', async () => {
    ...
    await expect(repo.update(entity))
      .rejects
      .toThrow(new NotFoundError(entity.entity_id, StubEntity))
  })
  ...
  it('should throws error on delete when entity not found', async () => {
    ...
    const uuid2 = new Uuid('9366b7dc-2d71-4799-b91c-c64adb205104')
    await expect(repo.delete(uuid2))
      .rejects
      .toThrow(new NotFoundError(uuid2, StubEntity));
  });
